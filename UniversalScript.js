...
function initalize() {
  ...
  var html ='<!DOCTYPE html><html lang="en"><head><link href="UniversalMenu.css" rel="stylesheet" type="text/css" /><title>TSI</title><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1"></head><body><div class="navbar1" id="navbar1"><img src="photos/logo.png" usemap="#map2" style="width:48px;height48px;float:left;"><map name="map2"><area shape="rect" coords="0,0,48,48" alt="Computer" href="index.html"></map><div class="dropdown1"><button class="dropbtn1">About  </button><div class="dropdown-content1"><a href="About.html">About us</a><a href="FAQ.html">FAQ</a> </div></div><div class="dropdown2"><button class="dropbtn2">Articles</button><div class="dropdown-content2"><a href="How.html">How to Be An Activist</a><a href="Examples.html">Examples of Activism</a><a href="Delegate.html">How to Delegate Tasks</a> <a href = "Email.html"> How to Write Professional Emails </a> </div></div> <!--- <div class = "dropdown3"><button class="dropbtn3">Dropdown</button><div class="dropdown-content3"><a href="#">Link 1</a><a href="#">Link 2</a> <a href="#">Link 3</a></div></div>---><div class="menuButton"><a onclick ="window.scrollTo(0,document.body.scrollHeight);">Contact us</a></div><div class="menuButton"><a href="Donate.html">Donate</a></div></div> ';
